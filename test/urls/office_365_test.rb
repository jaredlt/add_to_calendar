...
class Office365UrlTest < Minitest::Test
  def setup
    ...
    @url_with_defaults_required = "https://outlook.office365.com/owa/?path=/calendar/action/compose&rru=addevent" +
                                  "&subject=Holly%27s%208th%20Birthday%21" + 
                                  "&startdt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T123000Z" + 
                                  "&enddt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T133000Z"
  ...
  def test_with_only_required_attributes
    ...
    assert cal.office_365_url == @url_with_defaults_required
  end
  ...
  def test_without_end_datetime
    ...
    assert cal.office_365_url == "https://outlook.office365.com/owa/?path=/calendar/action/compose&rru=addevent" +
                                 "&subject=Holly%27s%208th%20Birthday%21" + 
                                 "&startdt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T123000Z" + 
                                 "&enddt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T133000Z"
  end
  ...
  def test_with_end_datetime
    ...
    assert cal.office_365_url == "https://outlook.office365.com/owa/?path=/calendar/action/compose&rru=addevent" +
                                 "&subject=Holly%27s%208th%20Birthday%21" + 
                                 "&startdt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T123000Z" + 
                                 "&enddt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T160000Z"
  end
  ...
  def test_with_end_datetime_crossing_over_midnight
    ...
    assert cal.office_365_url == "https://outlook.office365.com/owa/?path=/calendar/action/compose&rru=addevent" +
                                 "&subject=Holly%27s%208th%20Birthday%21" + 
                                 "&startdt=#{@next_month_year}#{@next_month_month}#{@next_month_day}T123000Z" + 
                                 "&enddt=#{@next_month_year}#{@next_month_month}#{@next_month_day.to_i+1}T160000Z"
  end
  ...
  def test_with_location
    ...
    assert cal.office_365_url == @url_with_defaults_required + "&location=Flat%204%2C%20The%20Edge%2C%2038%20Smith-Dorrien%20St%2C%20London%2C%20N1%207GU"
  end
  ...
  def test_with_url_without_description
    ...
    assert cal.office_365_url == @url_with_defaults_required + "&body=https%3A%2F%2Fwww.example.com%2Fevent-details"
  end
  ...
  def test_with_url_and_description
    ...
    assert cal.office_365_url == @url_with_defaults_required + "&body=Come%20join%20us%20for%20lots%20of%20fun%20%26%20cake%21%0A%0Ahttps%3A%2F%2Fwww.example.com%2Fevent-details"
  end
  ...
  def test_description_with_newlines_from_user_input
    ...
    assert cal.office_365_url == @url_with_defaults_required + "&body=Come%20join%20us%20for%20lots%20of%20fun%20%26%20cake%21%0A%0ADon%27t%20forget%20your%20swimwear%21%0A%0Ahttps%3A%2F%2Fwww.example.com%2Fevent-details"
  end
